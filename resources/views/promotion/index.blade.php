...
<div class="space-y-8 pb-12">
    <x-ui.card>
        <div class="flex items-center justify-between mb-4">
            ...
            @if(auth()->user()->can('Promotion Create') || auth()->user()->hasRole('Super Admin'))
                <x-ui.button href="{{ route('promotion.create') }}" color="primary" size="sm">
                    <i class="ri-add-line mr-1"></i> Add Promotion
                </x-ui.button>
            @endif
        </div>
