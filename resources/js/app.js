...
document.addEventListener("submit", (event) => {
    ...
    // SVG spinner icon
    const spinnerSvg = `<svg class="btn-submit-spinner" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    setTimeout(() => {
        submitButtons.forEach((button) => {
            ...
            // Ambil teks loading kustom jika ada, kalau tidak pakai teks asli
            const loadingText = button.getAttribute('data-loading-text') 
                || button.textContent.trim();

            // Simpan konten asli agar bisa di-restore jika perlu (misal: AJAX form)
